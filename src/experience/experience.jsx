...
import eCommerce from './png/ecommerce1.png'
    ...
    return (<>
        <div id="experience">
            ...
            <div className='cards-experience'>
                ...
                <Cards_Experience img_src={eCommerce} icon_text={t("see_more")} titulo={t("ecommerce")} subtitulo={t("web_site")} navigate_text={'/experience/ecommerce'} />
            </div>
        </div>
    </>)
}